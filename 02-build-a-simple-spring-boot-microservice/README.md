...
```bash
az spring-cloud app create -n simple-microservice -s azure-spring-cloud-<inject key="DeploymentID" enableCopy="false"/> -g spring-cloud-workshop-<inject key="DeploymentID" enableCopy="false"/> --assign-endpoint true --cpu 1 --memory 1Gi --instance-count 1
```
