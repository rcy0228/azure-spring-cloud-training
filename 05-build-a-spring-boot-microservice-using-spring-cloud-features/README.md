...
1. Open the Azure Portal and navigate to your Azure Spring Cloud instance. Click on **Logs**. This is a shortcut to the Log Analytics workspace that was created earlier. If a tutorial appears, feel free to skip it for now.
